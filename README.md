...
- **notebooks/**  
  Contains all Jupyter/Databricks notebooks. Each notebook name corresponds to the video title for easy reference.
  
- **data/**  
  Sample data files used in the tutorials. You can download these files locally or reference them directly within Databricks.

- **src/**  
  Custom helper functions and scripts to support notebook operations, such as data loading and transformations.
